...
class TrafficExplanation:
    """AI-generated explanation of traffic"""
    summary: str
...
ATTACK_EXPLANATIONS = {
    ...
    'Infiltration': {
        ...
        'explanation': 'Traffic patterns suggest unauthorized access or data exfiltration from internal hosts. This often follows initial compromise.',
        'recommendations': [
    ...
    'Vulnerability': {
        ...
        'explanation': 'Traffic patterns match signatures for known vulnerability exploitation attempts, such as Heartbleed.',
        'recommendations': [
...
class ExplanationEngine:
    """Generates AI explanations for traffic analysis"""
    ...
    def generate(self, traffic_data: Dict[str, Any], classification: Dict[str, Any]) -> TrafficExplanation:
        """Generate explanation based on traffic data and classification"""
    ...
    def _generate_summary(self, traffic_data: Dict[str, Any], classification: Dict[str, Any],
        ...
        """Generate dynamic traffic summary with real metrics"""
        ...
        if attacks:
            ...
            # Dynamic normal traffic assessment
            traffic_level = "High"
            if pps <= 100:
    ...
    def _generate_threat_analysis(
        ...
        """Generate dynamic, context-aware threat analysis"""
        confidence_pct = confidence * 100
        attacks = all_detected or []

        # Extract dynamic metrics from actual traffic
        ...
        # Dynamic analysis based on actual traffic patterns
        if label == 'Port Scan':
            ...
            analysis += f"- Rate: {pps:.1f} attempts/sec | Success probability: {'High' if pps > 10 else 'Low'}\n\n"
            analysis += f"**Threat Assessment:** "
    ...
    def _parse_openai_response(
        ...
        """Parse OpenAI response into explanation"""
